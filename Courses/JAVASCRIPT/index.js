$(document).ready(function(){
    ...
    // Web
    $(".fa-1").click(function(){
        $(".we").toggleClass("active-name");
        $(".music").removeClass("active-name");
        $(".heal").removeClass("active-name");
        $(".fa-1").toggleClass("active-picture");
        $(".fa-2").removeClass("active-picture");
        $(".fa-3").removeClass("active-picture");
        $(".musics").css("display","none");
        $(".health").css("display","none");
        $(".web").css("display","grid");
    });
    ...
    // health
    $(".fa-2").click(function(){
        $(".heal").toggleClass("active-name");
        $(".we").removeClass("active-name");
        $(".music").removeClass("active-name");
        $(".fa-1").removeClass("active-picture");
        $(".fa-2").toggleClass("active-picture");
        $(".fa-3").removeClass("active-picture");
        $(".web").css("display","none");
        $(".musics").css("display","none");
        $(".health").css("display","grid");
    });
    ...
    // music
    $(".fa-3").click(function(){
        $(".music").toggleClass("active-name");
        $(".heal").removeClass("active-name");
        $(".we").removeClass("active-name");
        $(".fa-1").removeClass("active-picture");
        $(".fa-2").removeClass("active-picture");
        $(".fa-3").toggleClass("active-picture");
        $(".web").css("display","none");
        $(".health").css("display","none");
        $(".musics").css("display","grid");
    });
    ...
    $(".numOfPicture .fa-angle-right").click(function(){
        if($(".fa-1").hasClass("active-picture")){
            $(".web").css("display","none");
            $(".health").css("display","grid");
            $(".musics").css("display","none");
            $(".we").removeClass("active-name");
            ...
            $(".fa-2").toggleClass("active-picture");
            $(".fa-3").removeClass("active-picture");
        } else if($(".fa-2").hasClass("active-picture")){
            $(".web").css("display","none");
            $(".health").css("display","none");
            $(".musics").css("display","grid");
            $(".we").removeClass("active-name");
            ...
            $(".fa-2").removeClass("active-picture");
            $(".fa-3").toggleClass("active-picture");
        } else if($(".fa-3").hasClass("active-picture")){
            $(".web").css("display","grid");
            $(".health").css("display","none");
            $(".musics").css("display","none");
            $(".we").toggleClass("active-name");
    ...
    // previous
    $(".numOfPicture .fa-angle-left").click(function(){
        if($(".fa-1").hasClass("active-picture")){
            $(".web").css("display","none");
            $(".health").css("display","none");
            $(".musics").css("display","grid");
            $(".we").removeClass("active-name");
            $(".heal").removClass("active-name");
            $(".music").toggleClass("active-name");
            $(".fa-1").removeClass("active-picture");
            $(".fa-2").removeClass("active-picture");
            $(".fa-3").toggleClass("active-picture");
