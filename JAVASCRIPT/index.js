$(document).ready(function(){
    ...
    $(".student-next").click(function(){
        if($(".point1").hasClass("active-point")){
            ...
            $(".student-child1").css("display","none");
            $(".student-child2").css("display","grid");
        } else if($(".point2").hasClass("active-point")){
            $(".point2").toggleClass("active-point");
            $(".point3").toggleClass("active-point");
            $(".student-child2").css("display","none");
            $(".student-child3").css("display","grid");
        } else if($(".point3").hasClass("active-point")){
            $(".point3").toggleClass("active-point");
            $(".point1").toggleClass("active-point");
            $(".student-child3").css("display","none");
            $(".student-child1").css("display","grid");
        }
    });
    // previous
