$(document).ready(function(){
    ...
    $(".contain-theme .dark-mood .cir-dark-mood").click(function(){
        ...
        $(".addres h1").css("color","#f9f8fa");
        $(".addres .icon").css("color","#f9f8fa");
        $(window).scroll(function(){
            if ( this.scrollY > 20){
                $(".header").addClass("headerEffect");
                $(".header .menu ul li a").css("color","#f9f8fa");
    ...
    $(".color1").click(function(){
        ...
        $(".addres .icon i").css("backgroundColor","#E55252");
    ...
    $(".color2").click(function(){
        ...
        $(".forms form textarea").css({
            "caret-color":"#526ae5",
            "color":"#526ae5"
        });

        $(".addres .icon i").css("backgroundColor","#526ae5");
    ...
    $(".color3").click(function(){
        ...
        $(".addres .icon i").css("backgroundColor","#e5aa52");
    ...
    $(".color4").click(function(){
        ...
        $(".addres .icon i").css("backgroundColor","#ad52e5");
    ...
    $(".color5").click(function(){
        ...
        $(".addres .icon i").css("backgroundColor","#52e5be");
